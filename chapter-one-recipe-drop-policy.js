(function attachChapterOneRecipeDropPolicy(root, factory) {
  ...
  const RECIPES = Object.freeze({
    greenWrist: recipe({ id: 'recipe-green-wrist', itemId: 'recipe-green-wrist', recipeId: 'chapter1-green-wrist', name: '綠色護腕配方', equipmentSlot: 'wrist', quality: 'uncommon', rarity: 'uncommon', resultEquipmentId: 'crafted-green-wrist' }),
    greenCloak: recipe({ id: 'recipe-green-cloak', itemId: 'recipe-green-cloak', recipeId: 'chapter1-green-cloak', name: '綠色斗篷配方', equipmentSlot: 'cloak', quality: 'uncommon', rarity: 'uncommon', resultEquipmentId: 'crafted-green-cloak' }),
    greenShoulders: recipe({ id: 'recipe-green-shoulders', itemId: 'recipe-green-shoulders', recipeId: 'chapter1-green-shoulders', name: '綠色肩甲配方', equipmentSlot: 'shoulders', quality: 'uncommon', rarity: 'uncommon', resultEquipmentId: 'crafted-green-shoulders' }),
    goblinRareCloak: recipe({ id: 'recipe-goblin-rare-cloak', itemId: 'recipe-goblin-rare-cloak', recipeId: 'chapter1-goblin-rare-cloak', name: '哥布林精良斗篷配方', equipmentSlot: 'cloak', quality: 'rare', rarity: 'rare', resultEquipmentId: 'crafted-goblin-rare-cloak' }),
    highChiefRareWrist: recipe({ id: 'recipe-high-chief-rare-wrist', itemId: 'recipe-high-chief-rare-wrist', recipeId: 'chapter1-high-chief-rare-wrist', name: '酋長精良護腕配方', equipmentSlot: 'wrist', quality: 'rare', rarity: 'rare', resultEquipmentId: 'crafted-high-chief-rare-wrist' }),
    blackKnightRareShoulders: recipe({ id: 'recipe-black-knight-rare-shoulders', itemId: 'recipe-black-knight-rare-shoulders', recipeId: 'chapter1-black-knight-rare-shoulders', name: '黑騎士精良肩甲配方', equipmentSlot: 'shoulders', quality: 'rare', rarity: 'rare', resultEquipmentId: 'crafted-black-knight-rare-shoulders' })
  });
