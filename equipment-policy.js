(function attachEquipmentPolicy(root, factory) {
  ...
  const WEAPON_CATALOG = Object.freeze({
    shortIronSword: Object.freeze({
      ...
      image: 'assets/short-iron-sword.png',
      attackMin: 8,
      attackMax: 11,
      attack: 10,
      attackSpeed: 1.40,
    ...
    knightLongsword: Object.freeze({
      ...
      slot: 'weapon',
      weaponType: 'one-handed-sword',
      image: 'assets/knight-longsword.png',
      attackMin: 10,
      attackMax: 14,
      attack: 12,
      attackSpeed: 1.20,
    ...
    mercenaryGreatsword: Object.freeze({
      ...
      image: 'assets/mercenary-greatsword.png',
      attackMin: 18,
      attackMax: 24,
      attack: 21,
      attackSpeed: .80,
    ...
    giantIronSword: Object.freeze({
      ...
      slot: 'weapon',
      weaponType: 'two-handed-sword',
      image: 'assets/giant-iron-sword.png',
      attackMin: 21,
      attackMax: 28,
      attack: 25,
      attackSpeed: .65,
    ...
    loggingHatchet: Object.freeze({
      ...
      image: 'assets/logging-hatchet.png',
      attackMin: 9,
      attackMax: 12,
      attack: 11,
      attackSpeed: 1.10,
    ...
    warriorHatchet: Object.freeze({
      ...
      slot: 'weapon',
      weaponType: 'one-handed-axe',
      image: 'assets/warrior-hatchet.png',
      attackMin: 11,
      attackMax: 15,
      attack: 13,
      attackSpeed: .95,
    ...
    battleGreataxe: Object.freeze({
      ...
      image: 'assets/battle-greataxe.png',
      attackMin: 20,
      attackMax: 26,
      attack: 23,
      attackSpeed: .70,
    ...
    rockbreakerGreataxe: Object.freeze({
      ...
      slot: 'weapon',
      weaponType: 'two-handed-axe',
      image: 'assets/rockbreaker-greataxe.png',
      attackMin: 23,
      attackMax: 30,
      attack: 27,
      attackSpeed: .55,
    ...
    hunterShortbow: Object.freeze({
      ...
      slot: 'weapon',
      weaponType: 'bow',
      image: 'assets/hunter-shortbow.png',
      attackMin: 9,
      attackMax: 13,
      attack: 11,
      attackSpeed: 1.10,
    ...
    longHuntingBow: Object.freeze({
      ...
      slot: 'weapon',
      weaponType: 'bow',
      image: 'assets/long-hunting-bow.png',
      attackMin: 11,
      attackMax: 15,
      attack: 13,
      attackSpeed: .90,
    ...
    assassinShortblade: Object.freeze({
      ...
      slot: 'weapon',
      weaponType: 'one-handed-dagger',
      image: 'assets/assassin-shortblade.png',
      attackMin: 8,
      attackMax: 11,
      attack: 10,
      attackSpeed: 1.60,
    ...
    apprenticeStaff: Object.freeze({
      ...
      slot: 'weapon',
      weaponType: 'staff',
      image: 'assets/apprentice-staff.png',
      attackMin: 10,
      attackMax: 15,
      attack: 13,
      attackSpeed: 1.00,
  ...
  const ARMOR_CATALOG = Object.freeze({
    ...
    apprenticeRobe: Object.freeze({
      ...
      slot: 'armor',
      armorType: 'cloth',
      image: 'assets/recruit-cloth-robe.png?v=20260801-user-image-v1',
      defense: 3,
      mana: 50,
      quality: '普通'
    }),
    novicePriestRobe: Object.freeze({
      ...
      slot: 'armor',
      armorType: 'cloth',
      image: 'assets/guard-cloth-robe.png?v=20260801-user-image-v1',
      defense: 2,
      mana: 15,
      manaRegenFlat: 1,
      quality: '普通'
    ...
    apprenticeClothPants: Object.freeze({
      ...
      slot: 'pants',
      armorType: 'cloth',
      image: 'assets/recruit-cloth-pants.png?v=20260801-user-image-v1',
      defense: 3,
      mana: 40,
      quality: '普通'
    }),
    novicePriestPants: Object.freeze({
      ...
      slot: 'pants',
      armorType: 'cloth',
      image: 'assets/guard-cloth-pants.png?v=20260801-user-image-v1',
      defense: 2,
      hp: 10,
      manaRegenFlat: 1,
      quality: '普通'
    ...
    apprenticeMageHat: Object.freeze({
      ...
      slot: 'head',
      armorType: 'cloth',
      image: 'assets/recruit-cloth-hood.png?v=20260801-user-image-v1',
      mana: 20,
      intelligence: 2,
      quality: '普通'
    }),
    noviceHeadscarf: Object.freeze({
      ...
      slot: 'head',
      armorType: 'cloth',
      image: 'assets/guard-cloth-hat.png?v=20260801-user-image-v1',
    ...
    apprenticeGloves: Object.freeze({
      ...
      slot: 'gloves',
      armorType: 'cloth',
      image: 'assets/recruit-cloth-gloves.png?v=20260801-user-image-v1',
      defense: 5,
      hp: 10,
      quality: '普通'
    }),
    noviceGloves: Object.freeze({
      ...
      slot: 'gloves',
      armorType: 'cloth',
      image: 'assets/guard-cloth-gloves.png?v=20260801-user-image-v1',
      defense: 3,
      hp: 15,
      quality: '普通'
    }),
    ...
    apprenticeClothShoes: Object.freeze({
      ...
      slot: 'boots',
      armorType: 'cloth',
      image: 'assets/recruit-cloth-shoes.png?v=20260801-user-image-v1',
      defense: 4,
      mana: 40,
      quality: '普通'
    }),
    arcaneLongBoots: Object.freeze({
      ...
      slot: 'boots',
      armorType: 'cloth',
      image: 'assets/guard-cloth-boots.png?v=20260801-user-image-v1',
      defense: 3,
      manaRegenFlat: 2,
      quality: '普通'
    })
