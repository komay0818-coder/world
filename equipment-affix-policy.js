(function attachEquipmentAffixPolicy(root, factory) {
  ...
  const SPECIAL_ABILITIES = Object.freeze({
    ...
    warblade_combo: specialAbility('warblade_combo', '戰刃連擊', '每 3 次主手普通攻擊命中後，第 4 次額外造成 50% 武器傷害。', { unlockChapter: 3, allowedGroups: ['weapon'], allowedSlots: ['weapon'] }),
    poised_break: specialAbility('poised_break', '破勢', '主手普攻暴擊使目標進入破勢；下一個命中的主動技能傷害 +20%。', { unlockChapter: 3, allowedGroups: ['weapon'], allowedSlots: ['weapon'] }),
    armor_shatter: specialAbility('armor_shatter', '碎甲', '主手普攻命中時有 20% 機率使目標防禦降低 15%，持續 5 秒。', { unlockChapter: 3, allowedGroups: ['weapon'], allowedSlots: ['weapon'] }),
    earthsplit_wound: specialAbility('earthsplit_wound', '裂地創傷', '主手普攻暴擊時造成 4 秒創傷，每秒造成該次實際傷害的 20%。', { unlockChapter: 3, allowedGroups: ['weapon'], allowedSlots: ['weapon'] }),
    bloodfang: specialAbility('bloodfang', '血牙', '主手普攻暴擊後，下一次傷害型主動技能的直接傷害 +30%。', { unlockChapter: 3, allowedGroups: ['weapon'], allowedSlots: ['weapon'] }),
    hunting_rhythm: specialAbility('hunting_rhythm', '狩獵節奏', '主手普攻命中後每層攻擊速度 +3%，持續 4 秒，最多 5 層。', { unlockChapter: 3, allowedGroups: ['weapon'], allowedSlots: ['weapon'] }),
    rune_cycle: specialAbility('rune_cycle', '符文循環', '每第 3 次實際消耗魔力的主動技能，使其他技能剩餘冷卻縮短 20%。', { unlockChapter: 3, allowedGroups: ['weapon'], allowedSlots: ['weapon'] }),
    holy_afterglow: specialAbility('holy_afterglow', '聖光餘韻', '主動技能直接治療後，使目標在 4 秒內額外恢復該次實際治療量的 20%。', { unlockChapter: 3, allowedGroups: ['weapon'], allowedSlots: ['weapon'] }),
