(function attachMonsterDisplayPolicy(root, factory) {
  ...
  const MONSTER_IMAGE_BY_TYPE = Object.freeze({
    ...
    goblinScout: 'assets/goblin-camp-scout.png?v=20260729-dedicated-image-v1',
    goblinWarrior: 'assets/goblin-camp-warrior.png?v=20260729-dedicated-image-v1',
    goblinSlinger: 'assets/goblin-camp-slinger.png?v=20260729-dedicated-image-v1',
    goblinShaman: 'assets/goblin-camp-shaman.png?v=20260729-dedicated-image-v1',
    goblinGuard: 'assets/goblin-camp-guard.png?v=20260729-dedicated-image-v1',
    goblinCaptain: 'assets/goblin-camp-captain.png?v=20260729-dedicated-image-v1',
    goblinTreasureChest: 'assets/goblin-transparent.png',
    goblinHighChief: 'assets/goblin-camp-high-chief.png?v=20260729-dedicated-image-v1',
