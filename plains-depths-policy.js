(function attachPlainsDepthsPolicy(root, factory) {
  ...
  const MONSTER_TYPES = Object.freeze({
    highlandWolf: Object.freeze({ id: 'highlandWolf', name: '高地野狼', maxHp: 90, attack: 14, defense: 6, evasion: 10, parry: 0, damageReduction: 2, artClass: 'monster-placeholder-art', xp: 10, gold: 5, lootPending: true }),
    rockbackBoar: Object.freeze({ id: 'rockbackBoar', name: '岩背野豬', maxHp: 115, attack: 16, defense: 12, evasion: 2, parry: 0, damageReduction: 8, artClass: 'monster-placeholder-art', xp: 10, gold: 6, lootPending: true }),
    blackstoneScout: Object.freeze({ id: 'blackstoneScout', name: '黑石斥侯', maxHp: 95, attack: 17, defense: 8, evasion: 7, parry: 8, damageReduction: 3, artClass: 'monster-placeholder-art', xp: 10, gold: 7, lootPending: true }),
    ...
    blackstoneRaider: Object.freeze({ id: 'blackstoneRaider', name: '黑石掠奪者', maxHp: 230, attack: 23, defense: 16, evasion: 5, parry: 15, damageReduction: 8, artClass: 'monster-placeholder-art', xp: 26, gold: 16, isElite: true, lootPending: true }),
