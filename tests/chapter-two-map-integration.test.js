...
assert.match(index, /VER\. 0\.4\.45/);
assert.match(index, /blackstone-stronghold-policy\.js\?v=20260810-combat-policy-v15/);
...
assert.match(index, /script\.js\?v=20260809-spider-combat-v131/);
