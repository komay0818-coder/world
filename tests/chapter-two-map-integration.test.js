...
assert.match(index, /VER\. 0\.4\.70/);
assert.match(index, /black-forest-depths-policy\.js\?v=20260810-depths-skills-v12/);
...
assert.match(index, /chapter-two-map-policy\.js\?v=20260810-depths-skills-v19/);
assert.match(index, /script\.js\?v=20260810-depths-skills-v137/);
