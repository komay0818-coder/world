...
assert.match(index, /VER\. 0\.4\.69/);
assert.match(index, /black-forest-depths-policy\.js\?v=20260810-depths-combat-v11/);
...
assert.match(index, /chapter-two-map-policy\.js\?v=20260810-depths-combat-v18/);
assert.match(index, /script\.js\?v=20260810-depths-combat-v136/);
