...
assert.match(index, /forest-altar-policy\.js\?v=20260810-altar-combat-v11/);
assert.match(index, /chapter-two-map-policy\.js\?v=20260810-altar-combat-v14/);
assert.match(index, /script\.js\?v=20260810-altar-combat-v134/);
