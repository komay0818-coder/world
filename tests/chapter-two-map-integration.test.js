...
assert.match(index, /VER\. 0\.4\.60/);
assert.match(index, /black-forest-depths-policy\.js\?v=20260810-depths-roster-v2/);
...
assert.match(index, /chapter-two-map-policy\.js\?v=20260810-depths-roster-v16/);
