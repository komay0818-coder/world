...
assert.match(index, /VER\. 0\.4\.46/);
assert.match(index, /blackstone-stronghold-policy\.js\?v=20260810-combat-integration-v16/);
...
assert.match(index, /script\.js\?v=20260810-stronghold-combat-v132/);
