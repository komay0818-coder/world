...
assert.match(index, /VER\. 0\.4\.15/);
assert.match(index, /black-forest-trail-policy\.js\?v=20260809-blackstone-beastmaster-v5/);
assert.match(index, /chapter-two-map-policy\.js\?v=20260809-trail-background-v5/);
