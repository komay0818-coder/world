...
assert.match(index, /VER\. 0\.4\.64/);
assert.match(index, /black-forest-depths-policy\.js\?v=20260810-depths-centurion-image-v6/);
...
assert.match(index, /chapter-two-map-policy\.js\?v=20260810-depths-background-v17/);
assert.match(index, /script\.js\?v=20260810-altar-skills-v135/);
