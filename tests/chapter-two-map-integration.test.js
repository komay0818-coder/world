...
assert.match(index, /VER\. 0\.4\.19/);
assert.match(index, /black-forest-trail-policy\.js\?v=20260809-trail-skills-v9/);
assert.match(index, /chapter-two-map-policy\.js\?v=20260809-trail-combat-v6/);
