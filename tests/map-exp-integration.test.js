...
require('node:assert/strict').match(script, /function requiredXp\(level\) \{\s*return MapExpPolicy\.requiredXp\(level\);\s*\}/, 'the UI and level-up loops use the approved shared requirement table');
