...
[
  'goblinScout', 'goblinWarrior', 'goblinSlinger', 'goblinShaman',
...
assert.equal(displayPolicy.MONSTER_IMAGE_BY_TYPE.goblinTreasureChest, 'assets/goblin-treasure-chest.png?v=20260831-monster-style-v1');
