...
assert.match(html, /46f09ef\/styles\/monster-slots\.css/, 'battlefield loads the current compact battlefield styles');
assert.match(html, /46f09ef\/script\.js/, 'battlefield loads the current character action logic');
