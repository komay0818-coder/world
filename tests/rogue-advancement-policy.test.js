...
assert.deepEqual(policy.getTargetBonuses(assassin, [{ type: 'bleed', remaining: 3 }], state, .29, 'skill', 2000), { damage: .12, crit: .08, criticalDamage: .40, dotDamage: 0, defenseReduction: 0 });
...
const dots = [{ type: 'poison', remaining: 3, nextTickAt: 3000 }, { type: 'poison', remaining: 3, nextTickAt: 3000 }, { type: 'poison', remaining: 3, nextTickAt: 3000 }, { type: 'rupture', remaining: 3, nextTickAt: 3000 }];
