...
assert.match(index, /script\.js\?v=20260810-depths-skills-v137/, 'the integration cache key changes');
assert.match(index, /VER\. 0\.4\.70/, 'the game version includes the black forest depths skill foundation');
