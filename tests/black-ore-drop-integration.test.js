...
assert.match(index, /script\.js\?v=20260810-altar-combat-v134/, 'the integration cache key changes');
assert.match(index, /VER\. 0\.4\.58/, 'the game version includes the forest altar combat foundation');
