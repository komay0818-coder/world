...
assert.match(index, /script\.js\?v=20260810-altar-skills-v135/, 'the integration cache key changes');
assert.match(index, /VER\. 0\.4\.64/, 'the game version includes the corrupted blackstone centurion image');
