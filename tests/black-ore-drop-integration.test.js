...
assert.match(index, /script\.js\?v=20260810-depths-boss-v138/, 'the integration cache key changes');
assert.match(index, /VER\. 0\.4\.71/, 'the game version includes the black forest depths boss phases');
