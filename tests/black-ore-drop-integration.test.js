...
assert.match(index, /script\.js\?v=20260810-depths-combat-v136/, 'the integration cache key changes');
assert.match(index, /VER\. 0\.4\.69/, 'the game version includes the black forest depths combat foundation');
