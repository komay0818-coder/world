...
assert.match(index, /script\.js\?v=20260810-stronghold-objective-v133/, 'the integration cache key changes');
assert.match(index, /VER\. 0\.4\.51/, 'the game version includes the corrupted blackstone soldier artwork');
