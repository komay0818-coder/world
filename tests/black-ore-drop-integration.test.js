...
assert.match(index, /world\/32d9183\/script\.js/, 'the integration script uses the immutable chapter-two material build');
assert.match(index, /VER\. 0\.6\.6/, 'the game version includes chapter-two materials');
