...
assert.equal(policy.RULES.implemented, true);
...
assert.ok(policy.MONSTERS.every((monster) => monster.level === 25 && monster.combatId !== null && monster.role !== null && monster.stats !== null
  && monster.dropTableId === null && monster.skillIds.length === 2 && monster.aiProfileId !== null && monster.implemented === true));
...
assert.equal(policy.resolveAction('heartOfTheBlackForest', .10), 'corruption-pulse');
