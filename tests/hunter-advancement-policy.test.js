...
assert.deepEqual(policy.applyGuardDamage(beastmaster, 1000), { hunterDamage: 750, petDamage: 250, livingPets: 3, usesRemaining: 2, triggered: true, share: .25 });
assert.deepEqual(policy.applyGuardDamage(beastmaster, 1000), { hunterDamage: 750, petDamage: 250, livingPets: 3, usesRemaining: 1, triggered: true, share: .25 });
assert.deepEqual(policy.applyGuardDamage(beastmaster, 1000), { hunterDamage: 750, petDamage: 250, livingPets: 3, usesRemaining: 0, triggered: true, share: .25 });
assert.deepEqual(policy.applyGuardDamage(beastmaster, 1000), { hunterDamage: 1000, petDamage: 0, livingPets: 3, usesRemaining: 0, triggered: false, share: 0 });
const noPets = { companions: [] };
assert.deepEqual(policy.applyGuardDamage(noPets, 1000), { hunterDamage: 1000, petDamage: 0, livingPets: 0, usesRemaining: 0, triggered: false, share: 0 });
