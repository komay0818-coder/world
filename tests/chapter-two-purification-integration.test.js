...
assert.match(index, /VER\. 0\.6\.4/);
assert.match(index, /world\/88042116bfbcc936d5b561889e63745c21c27881\/drop-lookup-policy\.js/, 'the live lookup policy includes purification materials');
