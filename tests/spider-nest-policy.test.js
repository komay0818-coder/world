...
const spiderNestMonsterImageVersion = '?v=20260920-spider-nest-monsters-v2';
assert.equal(policy.getMonster('venom-spitter-spider').image, `assets/venom-spitter-spider.png${spiderNestMonsterImageVersion}`);
assert.equal(policy.getMonster('web-weaver').image, `assets/web-weaver.png${spiderNestMonsterImageVersion}`);
assert.equal(policy.getMonster('blackstone-venom-hunter').image, `assets/blackstone-venom-hunter.png${spiderNestMonsterImageVersion}`);
assert.equal(policy.getMonster('blackstone-venomblade-assassin').image, `assets/blackstone-venomblade-assassin.png${spiderNestMonsterImageVersion}`);
assert.equal(policy.getMonster('giant-spider').image, `assets/giant-spider.png${spiderNestMonsterImageVersion}`);
...
const venomSpitter = fs.readFileSync(path.join(__dirname, '..', policy.getMonster('venom-spitter-spider').image.split('?')[0]));
...
const webWeaver = fs.readFileSync(path.join(__dirname, '..', policy.getMonster('web-weaver').image.split('?')[0]));
...
const venomHunter = fs.readFileSync(path.join(__dirname, '..', policy.getMonster('blackstone-venom-hunter').image.split('?')[0]));
...
const venombladeAssassin = fs.readFileSync(path.join(__dirname, '..', policy.getMonster('blackstone-venomblade-assassin').image.split('?')[0]));
...
const giantSpider = fs.readFileSync(path.join(__dirname, '..', policy.getMonster('giant-spider').image.split('?')[0]));
