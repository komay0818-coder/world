...
assert.match(script, /PartyPolicy\.scheduleNextAttack\(member, now, member\.attackSpeed \* skillHasteMultiplier \* blessingSpeedMultiplier \* corruptedSwiftnessMultiplier \* runeFrenzyMultiplier \* \(1 \+ \(desperate\?\.speed \|\| 0\)\), exhaustedMultiplier \* trailSlowMultiplier\)/, 'attack timing uses member speed, skill buffs, blessings, special equipment, runes, desperate speed and active trail slow effects');
