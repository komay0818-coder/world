...
assert.match(script, /PartyPolicy\.scheduleNextAttack\(member, now, member\.attackSpeed \* skillHasteMultiplier \* blessingSpeedMultiplier \* corruptedSwiftnessMultiplier \* runeFrenzyMultiplier \* huntingRhythmMultiplier \* warriorSpeedMultiplier \* galeSpeedMultiplier \* \(1 \+ \(desperate\?\.speed \|\| 0\)\), exhaustedMultiplier \* trailSlowMultiplier\)/, 'attack timing includes warrior and hunter advancement speed without replacing existing timing modifiers');
