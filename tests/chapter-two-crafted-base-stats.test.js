...
assert.ok(Object.values(crafting.RECIPES).filter((recipe) => recipe.chapter === 3).every((recipe) => recipe.baseStatsStatus === 'pending' || Object.keys(recipe.baseStats || {}).length === 0), 'chapter-three pending base stats remain untouched');
