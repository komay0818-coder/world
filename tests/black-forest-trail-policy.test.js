...
assert.equal(policy.getMonster('blackstone-captain').image, `assets/blackstone-captain.png${blackstoneMonsterImageVersion}`);
assert.equal(policy.getMonster('blackstone-centurion').image, `assets/blackstone-centurion.png${blackstoneMonsterImageVersion}`);
...
const archer = fs.readFileSync(path.join(__dirname, '..', policy.getMonster('blackstone-archer').image.split('?')[0]));
...
const beastmaster = fs.readFileSync(path.join(__dirname, '..', policy.getMonster('blackstone-beastmaster').image.split('?')[0]));
...
const captain = fs.readFileSync(path.join(__dirname, '..', policy.getMonster('blackstone-captain').image.split('?')[0]));
...
const centurion = fs.readFileSync(path.join(__dirname, '..', policy.getMonster('blackstone-centurion').image.split('?')[0]));
