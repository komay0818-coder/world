...
assert.equal(policy.getMonster('withered-tree-walker').image, `assets/withered-tree-walker.png${entranceMonsterImageVersion}`);
assert.equal(policy.getMonster('black-forest-hunter').image, `assets/black-forest-hunter.png${entranceMonsterImageVersion}`);
assert.equal(policy.getMonster('forest-guardian').image, `assets/forest-guardian.png${entranceMonsterImageVersion}`);
