...
assert.deepEqual(equipmentPolicy.WEAPON_CATALOG.apprenticeStaff.allowedJobs, ['mage', 'priest']);
assert.deepEqual(equipmentPolicy.WEAPON_CATALOG.arcaneStaff.allowedJobs, ['mage', 'priest']);
...
assert.equal(equipmentPolicy.WEAPON_CATALOG.mercenaryGreatsword.image, 'assets/mercenary-greatsword.png');
assert.equal(equipmentPolicy.WEAPON_CATALOG.giantIronSword.image, 'assets/giant-iron-sword.png');
...
assert.equal(chapterTwoWeapons.find((template) => template.id === 'greatwood-battleaxe').image, 'assets/greatwood-battleaxe.png');
...
assert.equal(chapterTwoWeapons.find((template) => template.id === 'ancient-wood-wand').image, 'assets/ancient-wood-wand.png');
assert.equal(chapterTwoWeapons.find((template) => template.id === 'ancient-wood-wand').imageStatus, 'ready');
assert.equal(chapterTwoWeapons.find((template) => template.id === 'spore-wand').image, 'assets/spore-wand.png');
assert.equal(chapterTwoWeapons.find((template) => template.id === 'spore-wand').imageStatus, 'ready');
chapterTwoWeapons.forEach((template) => assert.equal(template.imageStatus, 'ready', `${template.name} has final artwork`));
