(function (root, factory) {
  ...
  const SKILL_BOOK_RANKS = Object.freeze({
    ...
    advanced: Object.freeze({ id: 'advanced_skill_book', rank: '高階', image: 'assets/skill-book-advanced.png?v=20260815-user-image-v1', imageStatus: 'ready', implemented: false }),
    divine: Object.freeze({ id: 'divine_tome_tier_1', rank: '神聖一階', image: 'assets/skill-book-advanced.png?v=20260815-user-image-v1', imageStatus: 'ready', implemented: true }),
  ...
  const MATERIALS = Object.freeze({
    ...
    advanced_skill_page: Object.freeze({ ...SKILL_PAGE_RANKS.advanced, kind: 'material', icon: '📜', name: '高階技能殘頁', chapter: 3, materialType: 'page', stackable: true, implemented: false }),
    advanced_skill_book: Object.freeze({ ...SKILL_BOOK_RANKS.advanced, kind: 'material', icon: '📙', name: '高階法書', chapter: 3, materialType: 'book', stackable: true, implemented: false }),
    divine_tome_tier_1: Object.freeze({ ...SKILL_BOOK_RANKS.divine, kind: 'material', icon: '📖', name: '神聖法書（一階）', chapter: 3, materialType: 'divine-book', stackable: true })
  });

  const CHAPTERS = Object.freeze([
    Object.freeze({ chapter: 1, minSkillLevel: 1, maxSkillLevel: 3, pageMaterialId: 'beginner_skill_page', bookMaterialId: 'beginner_skill_book' }),
    Object.freeze({ chapter: 2, minSkillLevel: 3, maxSkillLevel: 5, pageMaterialId: 'intermediate_skill_page', bookMaterialId: 'intermediate_skill_book' }),
    Object.freeze({ chapter: 3, minSkillLevel: 5, maxSkillLevel: 6, bookMaterialId: 'divine_tome_tier_1', divine: true })
  ]);
  ...
  const DROP_CONFIG = Object.freeze({
    ...
    3: Object.freeze({
      materials: Object.freeze([
        Object.freeze({ materialId: 'divine_tome_tier_1', chance: .0025, amount: 1 })
      ])
    })
  });
  ...
  function getUpgradeRequirement(currentLevel) {
    ...
    return {
      ...
      gold: cost.gold,
      materials: [
        ...(chapter.pageMaterialId ? [{ ...MATERIALS[chapter.pageMaterialId], amount: cost.pages }] : []),
        { ...MATERIALS[chapter.bookMaterialId], amount: chapter.divine ? 1 : cost.books }
      ],
      divine: Boolean(chapter.divine)
    };
  }
