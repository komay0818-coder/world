(function (root, factory) {
  ...
  const ENEMIES = Object.freeze({
    ...
    skullcrusherBerserker: enemy('skullcrusher-berserker', '碎顱狂戰士', 'normal', ['blood-rage'], 'assets/skullcrusher-berserker.png'),
    skullcrusherShieldguard: enemy('skullcrusher-shieldguard', '碎顱盾衛', 'normal', ['shield-wall'], 'assets/skullcrusher-shieldguard.png'),
    skullcrusherHunter: enemy('skullcrusher-hunter', '碎顱獵手', 'normal', ['hunting-mark'], 'assets/skullcrusher-hunter.png'),
    skullcrusherShaman: enemy('skullcrusher-shaman', '碎顱薩滿', 'normal', ['warblood-totem'], 'assets/skullcrusher-shaman.png'),
    skullcrusherCenturion: enemy('skullcrusher-centurion', '碎顱百夫長', 'elite', ['centurion-cleave', 'battle-formation-command'], 'assets/skullcrusher-centurion.png'),
    skullcrusherVanguard: enemy('skullcrusher-vanguard-commander', '碎顱先鋒統領', 'boss', ['vanguard-smash', 'full-army-charge', 'fight-to-the-end'], 'assets/skullcrusher-vanguard-commander.png'),
    ...
    skullcrusherPriest: enemy('skullcrusher-priest', '碎顱祭司', 'normal', ['fel-prayer']),
    skullcrusherFanatic: enemy('skullcrusher-fanatic', '碎顱狂信者', 'normal', ['death-sacrifice']),
    ancientStoneguard: enemy('ancient-stoneguard', '遠古石衛', 'normal', ['petrified-body']),
