(function (root, factory) {
  ...
  const ENEMIES = Object.freeze({
    ...
    skullcrusherBerserker: enemy('skullcrusher-berserker', '碎顱狂戰士', 'normal', ['blood-rage']),
    skullcrusherShieldguard: enemy('skullcrusher-shieldguard', '碎顱盾衛', 'normal', ['shield-wall']),
    skullcrusherHunter: enemy('skullcrusher-hunter', '碎顱獵手', 'normal', ['hunting-mark']),
