(function attachEquipmentDropPolicy(root, factory) {
  ...
  const CHAPTER_TWO_TEMPLATES = Object.freeze([
    ...
    chapterTwoTemplate('ancient-wood-wand', '古木魔杖', 'weapon', { attackMin: 23, attackMax: 31, attackSpeed: 1.15, mana: 20 }, { weaponType: 'one-handed-wand', image: 'assets/ancient-wood-wand.png', imageStatus: 'ready', allowedJobs: ['mage', 'priest'], specialAbilityIds: ['mage_fireball_burn'] }),
    chapterTwoTemplate('spore-wand', '孢子魔杖', 'weapon', { attackMin: 26, attackMax: 35, attackSpeed: 1.00, mana: 26 }, { weaponType: 'one-handed-wand', image: 'assets/spore-wand.png', imageStatus: 'ready', allowedJobs: ['mage', 'priest'], specialAbilityIds: ['mage_fireball_burn'] }),
