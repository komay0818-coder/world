(function attachEquipmentDropPolicy(root, factory) {
  ...
  const CHAPTER_TWO_TEMPLATES = Object.freeze([
    ...
    chapterTwoTemplate('blackstone-corrupted-plate', '黑石腐晶戰甲', 'armor', { defense: 30, hp: 58, parry: .05 }, { armorType: 'heavy', allowedJobs: ['warrior'] }),
    chapterTwoTemplate('blackstone-corrupted-helm', '黑石腐晶戰盔', 'head', { defense: 18, hp: 32, parry: .03 }, { armorType: 'heavy', allowedJobs: ['warrior'] }),
