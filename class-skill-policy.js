  ...
  const SKILLS = Object.freeze({
    ...
    hunter: Object.freeze([
      ...
      passive(8, 'wild-bond', '野性羈絆', [
        { companionAttack: .20 }, { companionAttack: .24 }, { companionAttack: .28, companionSpeed: .1 },
        { companionAttack: .32, companionSpeed: .1 }, { companionAttack: .36, beastSlam: 1.8 },
        { companionAttack: .40, beastSlam: 2.2, nextHunterAttack: .25, breakthrough: '強化野獸猛擊並強化獵人下一次攻擊' }
      ]),
    ...
    mage: Object.freeze([
      ...
      active(10, 'chain-lightning', '閃電鏈', 9, [
        ...
        { power: 1.5, targets: 5, paralysis: true, paralysisDuration: 4 },
        { power: 1.6, targets: 5, paralysis: true, paralysisDuration: 4, shockedVulnerability: .5, shockedDuration: 4, bounceBonus: .05, breakthrough: '感電易傷：施法者本人後續造成的所有傷害提高 50%；每次彈射傷害 +5%' }
      ], { targets: 5 }),
